...
var (
	globalRegisteredTransform = []TransformRegistry{
		...
		// 		},
		{
			name:        "text-to-speech",
			inputTypes:  []transform.TransformType{transform.TransformTypeText},
			outputTypes: []transform.TransformType{transform.TransformTypeAudio},
			operations:  []transform.TransformOperation{transform.TransformOperationTextToSpeech},
			cb:          TextToSpeech,
		},
		{
			name:        "speech-to-text",
			inputTypes:  []transform.TransformType{transform.TransformTypeAudio},
			outputTypes: []transform.TransformType{transform.TransformTypeText},
			operations:  []transform.TransformOperation{transform.TransformOperationASR},
			cb:          AudioASR,
		},
		// 		{
		// 			name:        "text-to-image",
