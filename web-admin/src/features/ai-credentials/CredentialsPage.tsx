...
import CredentialEditorDialog from '@/features/ai-credentials/CredentialEditorDialog'
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <div className="text-sm text-[hsl(var(--muted-foreground))]">
            Manage reusable secret references for AI backends.
          </div>
        </div>
          ...
          {filteredCredentials.length === 0 ? (
            <div className="rounded-[var(--radius)] border border-dashed border-[hsl(var(--border))] bg-[hsl(var(--background))] px-4 py-8 text-center">
              ...
              <div className="mt-1 text-sm text-[hsl(var(--muted-foreground))]">
                Create a credential to reuse API keys across backend definitions.
              </div>
            </div>
          ) : (
